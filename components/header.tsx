...
export default function Header() {
  return (
    <header className="relative z-20 flex items-center justify-between p-4 md:p-6">
      ...
      <div className="flex items-center">
        <Link href="/contact">
          <button className="px-3 py-1.5 md:px-6 md:py-2 rounded-full bg-white text-black font-medium text-xs md:text-sm transition-all duration-300 hover:bg-white/90 hover:scale-105">
            Get Started
          </button>
        </Link>
      </div>
